...
/**
 * Created by hp on 26/7/2561.
 */

public class DataBloods {
    ...
    public DataBloods(int sugar, int sodium, double potassium, int cholesteral, int ldl, int hdl, int trigryceride) {
        this.sugar = sugar;
        this.sodium = sodium;
