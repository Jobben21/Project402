...
public class Blood_potssium extends AppCompatActivity {
    ...
    private TextView p_pos;
    private TextView p_pos2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_pos=(TextView)findViewById(R.id.data_Potassium);
...
//            Toast.makeText(ProfileOfBloodsActivity.this,row1[0]+row1[1]+"",Toast.LENGTH_SHORT).show();
            ...
            }else if(this.result.length()==2)
            {
                ...
                if(Integer.valueOf(getPotassium(0))>avg){
                    p_img.setImageResource(id2);
                }else if(Integer.valueOf(getPotassium(0))<avg){
            ...
            }else if(this.result.length()==3)
            {
                ...
                p_pos3.setText(getPotassium(2));

                avg = (Integer.valueOf(getPotassium(0))+Integer.valueOf(getPotassium(1))
            ...
            else if(this.result.length()==4)
            {
                ...
                p_pos4.setText(getPotassium(3));

                avg = (Integer.valueOf(getPotassium(0))+Integer.valueOf(getPotassium(1))
                        +Integer.valueOf(getPotassium(2))
                ...
                p_pos.setText(getPotassium(this.result.length()-4));

                p_pos2.setText(getPotassium(this.result.length()-3));

                p_pos3.setText(getPotassium(this.result.length()-2));


                p_pos4.setText(getPotassium(this.result.length()-1));

                avg = (Integer.valueOf(getPotassium(this.result.length()-4))+Integer.valueOf(getPotassium(this.result.length()-3))
                        +Integer.valueOf(getPotassium(this.result.length()-2))
                ...
                if(Integer.valueOf(getPotassium(this.result.length()-4))>avg){
                    p_img.setImageResource(id2);
                }else if(Integer.valueOf(getPotassium(this.result.length()-4))<avg){
                    p_img.setImageResource(id);
                }else{
                    p_img.setVisibility(View.GONE);
                }
