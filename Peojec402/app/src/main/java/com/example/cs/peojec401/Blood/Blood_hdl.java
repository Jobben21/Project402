...
public class Blood_hdl extends AppCompatActivity {
    ...
    private TextView p_hdl;
    private TextView p_hdl2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_hdl=(TextView)findViewById(R.id.data_hdl);
        p_hdl2=(TextView)findViewById(R.id.data_hdl2);
...
//            Toast.makeText(ProfileOfBloodsActivity.this,row1[0]+row1[1]+"",Toast.LENGTH_SHORT).show();
            ...
            }else if(this.result.length()==3)
            {
                ...
                p_hdl3.setText(getHdl(2));

                avg = (Integer.valueOf(getHdl(0))+Integer.valueOf(getHdl(1))
            ...
            else if(this.result.length()==4)
            {
                ...
                p_hdl4.setText(getHdl(3));

                avg = (Integer.valueOf(getHdl(0))+Integer.valueOf(getHdl(1))
                        +Integer.valueOf(getHdl(2))
                ...
                p_hdl.setText(getHdl(this.result.length()-4));

                p_hdl2.setText(getHdl(this.result.length()-3));

                p_hdl3.setText(getHdl(this.result.length()-2));


                p_hdl4.setText(getHdl(this.result.length()-1));

                avg = (Integer.valueOf(getHdl(this.result.length()-4))+Integer.valueOf(getHdl(this.result.length()-3))
                        +Integer.valueOf(getHdl(this.result.length()-2))
