...
public class Blood_ldl extends AppCompatActivity {
    ...
    private TextView p_ldl;
    private TextView p_ldl2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_ldl=(TextView)findViewById(R.id.data_ldl);
        p_ldl2=(TextView)findViewById(R.id.data_ldl2);
...
//            Toast.makeText(ProfileOfBloodsActivity.this,row1[0]+row1[1]+"",Toast.LENGTH_SHORT).show();
            ...
            }else if(this.result.length()==3)
            {
                ...
                p_ldl3.setText(getLdl(2));
                avg = (Integer.valueOf(getLdl(0))+Integer.valueOf(getLdl(1))
            ...
            else if(this.result.length()==4)
            {
                ...
                p_ldl4.setText(getLdl(3));

                avg = (Integer.valueOf(getLdl(0))+Integer.valueOf(getLdl(1))
                        +Integer.valueOf(getLdl(2))
                ...
                p_ldl.setText(getLdl(this.result.length()-4));

                p_ldl2.setText(getLdl(this.result.length()-3));

                p_ldl3.setText(getLdl(this.result.length()-2));


                p_ldl4.setText(getLdl(this.result.length()-1));

                avg = (Integer.valueOf(getLdl(this.result.length()-4))+Integer.valueOf(getLdl(this.result.length()-3))
                        +Integer.valueOf(getLdl(this.result.length()-2))
