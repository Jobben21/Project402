...
//        mProgressView = findViewById(R.id.login_progress);
    ...
    public boolean SaveData(){
        ...
        String url = "http://172.25.74.140/android/addData.php?status=0";
...
//        Age_login.setError(null);
//        weight_login.setError(null);
//        height_login.setError(null);
//
//
...
//
//        String age_login = Age_login.getText().toString();
//        String weightlogin = weight_login.getText().toString();
//        String heightlogin = height_login.getText().toString();
//
...
//            cancel = true;
//        }
//        if (!TextUtils.isEmpty(age_login) && !isAgeValid(age_login)) {
//            Age_login.setError(getString(R.string.error_invalid_password));
//            focusView = Age_login;
//            cancel = true;
//        }
//        if (!TextUtils.isEmpty(weightlogin) && !isWeightValid(weightlogin)) {
//            weight_login.setError(getString(R.string.error_invalid_password));
//            focusView =  weight_login;
//            cancel = true;
//        }
//        if (!TextUtils.isEmpty(heightlogin) && !isHeightValid(heightlogin)) {
//            height_login.setError(getString(R.string.error_invalid_password));
//            focusView =  height_login;
//            cancel = true;
//        }
//
//
