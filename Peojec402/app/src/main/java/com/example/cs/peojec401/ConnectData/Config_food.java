...
public class Config_food {
    public static final String DATA_URLSugar = "http://172.25.74.91/android/get_foodsugar1.php?status=0";
    public static final String DATA_URLKidney = "http://172.25.74.91/android/get_foodkidney.php?status=0";
    public static final String DATA_URLBT= "http://172.25.74.91/android/get_foodsugar1.php?status=0";
