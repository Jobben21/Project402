...
public class Blood_tri extends AppCompatActivity {
    ...
    private TextView p_tri;
    private TextView p_tri2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_tri=(TextView)findViewById(R.id.data_tri);
        p_tri2=(TextView)findViewById(R.id.data_tri2);
        ...
        p_img = (ImageView)findViewById(R.id.img_tri);
...
//            Toast.makeText(ProfileOfBloodsActivity.this,row1[0]+row1[1]+"",Toast.LENGTH_SHORT).show();
            ...
            }else if(this.result.length()==2)
            {
                ...
                }else if(Integer.valueOf(getTri(0))<avg){
            ...
            else if(this.result.length()==4)
            {
                ...
                p_tri.setText(getTri(this.result.length()-4));

                p_tri2.setText(getTri(this.result.length()-3));

                p_tri3.setText(getTri(this.result.length()-2));


                p_tri4.setText(getTri(this.result.length()-1));

                avg = (Integer.valueOf(getTri(this.result.length()-4))+Integer.valueOf(getTri(this.result.length()-3))
                        +Integer.valueOf(getTri(this.result.length()-2))
                ...
                if(Integer.valueOf(getTri(this.result.length()-4))>avg){
                    p_img.setImageResource(id2);
                }else if(Integer.valueOf(getTri(this.result.length()-4))<avg){
                    p_img.setImageResource(id);
                }else{
                    p_img.setVisibility(View.GONE);
                }
