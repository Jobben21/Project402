...
public class BackgroundTask extends AsyncTask<Void,FoodList,Void>
{
 ...
 public  static String nomenu="";
    ...
    String json_string="";
    String json_string1 = "http://192.168.1.10/android/get_foodheart.php?status=0";
    String json_string2 = "http://192.168.1.10/android/get_foodkidney.php?status=0";
    String json_string3 = "http://192.168.1.10/android/get_foodsugar.php?status=0";
    String json_string4 = "http://192.168.1.10/android/get_foodpressure.php?status=0";
    String json_string5 = "http://192.168.1.10/android/get_food_by_select.php";
    String json_string6 = "http://192.168.1.10/android/get_food_by_blood.php";
