...
public class AfterCalCulate2 extends AppCompatActivity {
    ...
    public void checkData(float bmiValue){
        ...
        if(bmiValue > 30){
            ...
            BMI_description.setText("ปรับเปลี่ยนอาหารจากที่ให้พลังงานมากเป็นอาหารที่ให้พลังงานน้อย ทั้งนี้พลังงานที่ได้รับไม่ควรต่ำกว่า 1200 กิโลแคลอรีต่อวัน ลดอาหารไขมัน/เนื้อสัตว์ อาหารผัด/ทอด ขนมหวาน เครื่องดื่มที่ใส่น้ำตาล แอลกอฮอล์");
            BMI_description2.setText("แอโรบิกอย่างสม่ำเสมอทุกวัน อย่างน้อยวันละ 30 นาทีแบ่งเป็นวันละ 2 - 3 ครั้งและเพิ่มการเคลื่อนไหวร่างกายให้มากขึ้น เพื่อให้มีการใช้พลังงานเพิ่มขึ้น อย่างน้อยวันละ 200 - 300 กิโลแคลอรี");
